...
# 1 "./MCAL_Layer/TIMER1/../interrupt/mcal_interrupt_gen_config.h" 1
...
timer1_config_t Timer1_Obj={.TIMER1_HandlerInterrupt=Timer1_Interrupt,
                            ...
                            .timer1_mode_timer_or_counter=0,
                            .timer1_mode_wr_reg=0,
                            .timer1_oscillator_enable=0,
                            .timer1_pre_scaler_val=2};
...
int main(void) {
    ...
    while(1){
        ...
        _delay((unsigned long)((7500)*(8000000UL/4000000.0)));
